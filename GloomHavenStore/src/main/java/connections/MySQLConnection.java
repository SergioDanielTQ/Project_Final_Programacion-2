...
public class MySQLConnection {
    ...
    private static String JDBC_DB = "dbTienda"; // Recuerda cambiarla según tus datos
    ...
    private static String JDBC_USER = "root";// Recuerda cambiarlo según tus datos
    // Contraseña de la base de datos
    private static String JDBC_PASS = "1423"; // Recuerda cambiarla según tus datos
